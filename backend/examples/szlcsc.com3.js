...
async function crawlerOnePage(page, url ) {
  ...
  res  = await page.evaluate( resultSelector  => {
      ...
      const rowsSelector = '#producContainer table.inside';
      ...
      return rows.map( row =>  {
          ...
          //pt.cat = row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(1)').textContent.trim().replace(/\s+/g, "").replace(/\r\n|\n/g, "");;
          //pt.pt = row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(2)').textContent.trim().replace(/\s+/g, "").replace(/\r\n|\n/g, "");;
          //pt.attr = row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(3)').textContent.trim().replace(/\s+/g, "").replace(/\r\n|\n/g, "");;
          //pt.pkg= row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(4)').textContent.trim().replace(/\s+/g, "").replace(/\r\n|\n/g, "");;

          pt.cat = row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(1)').textContent.trim();
          pt.pt = row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(2)').textContent.trim();
          pt.attr = row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(3)').textContent.trim();
          pt.pkg= row.querySelector('tbody > tr > td.two > div.two_01 > ul.l02_zb > li:nth-child(4)').textContent.trim();
